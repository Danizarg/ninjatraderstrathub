...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class ATL_MNQ_5M_Long_v5 : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "ATL_MNQ_5M_Long_v5";
                Description = "MNQ: 5-minute setups, 1000-tick entries, 15/60/240-minute trend filters. Long-only; one contract, no rebuy.";
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (setup != 1 || setupTime <= consumedSetup) return;
            DateTime ignored;
            ...
            bool trigger = Close[0] > Open[0] && Close[0] > entryEma[0];
            if (!trigger) return;
